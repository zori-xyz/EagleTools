...
(() => {
  ...
  const dict = {
    ru: {
      ...
      tab_profile: "Профиль",
      tab_help: "Помощь",
      smart_hero_title: "Вставь ссылку на видео или трек",
      smart_or: "или",
      smart_choose_file: "Прикрепить файл",
      smart_files_chip: "📎 до 100 МБ",
    ...
    en: {
      ...
      tab_profile: "Profile",
      tab_help: "Help",
      smart_hero_title: "Paste a link to video or track",
      smart_or: "or",
      smart_choose_file: "Attach a file",
      smart_files_chip: "📎 up to 100 MB",
